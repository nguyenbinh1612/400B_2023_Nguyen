...
# Code by: Binh Nguyen. Partly based on code I previously wrote during UFD research with Dr. Gurtina Besla
...
# and simulation snapshot
    ...
    def COM_V(self, x_COM, y_COM, z_COM):
        ...
        # round all values                                                                                        
        return np.round(v_COM*(u.kilometer/u.second), 2) # here, the units are added again